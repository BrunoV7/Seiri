...
export default function Login() {
  ...
  const FormSchema = z.object({
    ...
    password: z.string().min(8, {
      message: "Não conseguimos autenticar com essa senha.",
    }),
  });
  ...
  return (
    <section className="w-full h-dvh flex p-6 md:p-2 lg:mt-2 flex-col gap-6 items-center">
      ...
      <div className="flex flex-col w-full md:w-8/10 lg:w-4/10 gap-4">
        <div className="text-xl text-center">
          <h1 className="font-bold">Bem-vindo de volta!</h1>
          <p className="text-muted-foreground text-md">
            Organize suas ideias com clareza. Entre na sua conta para retomar de
            onde parou.
          </p>
        </div>
